...
<head>
    ...
    <link rel="stylesheet" href="panelFacture.css">
...
<body>
        ...
        <div class="slide-menu">
            ...
            <div class="menu">
                <ul>
                    ...
                    <a href="panelFacture.php"><li class="active-link"><i class='bx bx-money-withdraw'></i>&nbsp;Factures</li></a>
    ...
    <div class="dash-container">
        <div class="head-menu">
            <div class="title">
                <i class='bx bx-money-withdraw'></i>&nbsp;Factures
            </div>
            <div class="tools">
                <div class="search">
