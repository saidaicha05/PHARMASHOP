...
<head>
    ...
    <title>Clients suivis</title>
    <link rel="stylesheet" href="panelClients.css">
...
<body>
        ...
        <div class="slide-menu">
            ...
            <div class="menu">
                <ul>
                    ...
                    <a href="panelClients.php"><li class="active-link"><i class='bx bxs-message-alt-detail'></i>&nbsp;Clients suivis</li></a>
    ...
    <div class="dash-container">
        <div class="head-menu">
            <div class="title">
                <i class='bx bxs-message-alt-detail'></i>&nbsp;Clients suivis
            </div>
            <div class="tools">
                <div class="search">
