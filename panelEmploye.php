...
<head>
    ...
    <link rel="stylesheet" href="panelEmploye.css">
...
<body>
    ...
    <div class="dash-container">
        <div class="head-menu">
            <div class="title">
                <i class='bx bx-user-circle' ></i>&nbsp;Employés
            </div>
            <div class="tools">
                <div class="search">
                ...
                <div class="tool">
                    <a href="nouvEmpl.php" class="btn">Nouveau +</a>
        ...
        <div class="tab">
            <!-- <table>
                ...
                <tr>
                    <td><input type="text" name="matricule" id=""></td>
                    <td><input type="text" name="nom_prenom" id=""></td>
                    <td><input type="text" name="email" id=""></td>
                    <td><input type="text" name="contact" id=""></td>
                    <td><input type="text" name="poste" id=""></td>
                    <td class="action"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <tr>
                  <td>
                    <input type="text" name="matricule" id=""></td>
                    <td><input type="text" name="nom_prenom" id=""></td>
                    <td><input type="text" name="email" id=""></td>
                    <td><input type="text" name="contact" id=""></td>
                    <td><input type="text" name="poste" id=""></td>
...
if ($result->num_rows > 0) {
    ...
    echo "<table>";
    echo "<tr><th>matricule</th><th>nomprenom</th><th>email</th><th>contact</th><th>poste</th></tr>";
